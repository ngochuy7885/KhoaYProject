<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="CheckOutConfirm.aspx.cs" Inherits="CheckOutConfirm" %>
     ...
     <div class="col-md-12">
      ...
      <p><h3>Thông Tin Vận Chuyển</h3></p>
        ...
        <Triggers>
          ...
          <Triggers>
                <%--<asp:AsyncPostBackTrigger ControlID="commandConfirm" EventName="Click" />--%>
